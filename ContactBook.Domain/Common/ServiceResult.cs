...
public class ServiceResult
{
    ...
    public ServiceResult(bool success, string message, ErrorCode errorCode)
    {
        Success = success;
        Message = message;
        ErrorCode = errorCode;
    ...
    public static ServiceResult SuccessResult(string message = "") => new(true, message, ErrorCode.None);
